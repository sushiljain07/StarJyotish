...
import * as C from '../../../config/marriageGunaMilanContent'
...
export default function GunaMilanGuide() {
  ...
  return (
    <KnowledgeLayout
      seoTitle="Guna Milan — Marriage & Compatibility Path"
      seoDescription={C.HERO.subtitle}
      path="/learn/marriage/guna-milan"
      eyebrow="Marriage & Compatibility · Part 4 of 7"
      title={C.HERO.title}
    ...
    >
      ...
      <div className="mt-10">
        <RelatedArticles variant="next" title="Marriage & Compatibility path" items={[
          { title: 'Mangal Dosha: The Facts Without the Fear', href: '/learn/marriage/mangal-dosha', comingSoon: false, description: 'Continue the path.' },
        ]} />
      </div>
    </KnowledgeLayout>
  )
